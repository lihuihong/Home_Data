    ...
    <form class="layui-form frameContent layui-form-pane" lay-filter="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="worknum" lay-verify="required" id="worknum" placeholder="工号" autocomplete="off" class="layui-input" >
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name"  placeholder="请输入真实姓名" autocomplete="off" class="layui-input" lay-verify="truename">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="contact" lay-verify="phone" placeholder="请输入联系方式" autocomplete="off" class="layui-input" >
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-form-label">居住地址</div>
            <div class="layui-input-block">
                <input type="text" name="residentialaddress"  placeholder="请输入居住地址" autocomplete="off" class="layui-input" >
            </div>
        </div>
...
<script>
    ...
    layui.use(['form'], function(){
        ...
        if(data!=null){
            ...
            $('#worknum').attr("readonly","readonly");
            //表单初始赋值
            form.val('form', {
                "id":data.id
